...
def convertStarter():
    ...
    for infile in glob.glob("./testicons/*.png"):
        ...
        #drawtest = ImageDraw.Draw(output)
    ...
    #PIL image masking, creating little thumbnails (marker stuff, can also use variable size one)
    #https://stackoverflow.com/questions/890051/how-do-i-generate-circular-thumbnails-with-pil

    #image style: ./images\los_pericos_santa_cruz (but flag name)
    #url style: path to png